...
accidents_tbl_2 %>% 
    ...
    # here I can use case_when instead of cut 
    ...
    # removal of not-interesting columns
    select(-nonFlying_fatalities, -notes, -citation, -rest, - distance_flag) %>% 
